...
lista.push({
    ...
    resposta: "Isto deve ser tratado a parte com o motorista."
})
lista.push({
    pergunta: "Como posso obter um orçamento para a minha mudança?",
    resposta: "Você pode acessar a página \"Mudanças\" para receber uma estimativa. Tenha em mente que os preços podem sofrer alterações até a finalização do pedido."
})
lista.push({
    pergunta: "Posso agendar uma mudança em um final de semana ou feriado?",
    resposta: "Sim, você pode agendar uma mudança para qualquer data, mas não podemos garantir que haverá alguém para lhe atender."
})
lista.push({
    pergunta: "O que devo fazer se precisar reagendar minha mudança?",
